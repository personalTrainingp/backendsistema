...
// const { fontsRoboto } = require("../public/fonts/fontsRoboto");
...
// const fonts = {
//   Roboto: {
//     normal: "node_modules/pdfmake/build/vfs_fonts/Roboto-Italic.ttf",
//     bold: "node_modules/pdfmake/build/vfs_fonts/Roboto-Italic.ttf",
//     italics: "node_modules/pdfmake/build/vfs_fonts/Roboto-Italic.ttf",
//     bolditalics: "node_modules/pdfmake/build/vfs_fonts/Roboto-Italic.ttf",
//   },
// };
...
const descargarContratoProvPDF = async (req = request, res = response) => {
  ...
  try {
    ...
    //   },
    // });
    // // Añadir las fuentes embebidas
    // printer.vfs = fonts.pdfMake.vfs;
    // const dataProv = {
    ...
    //     "This is a simple example of pdfmake in Node.js.",
    //     { text: "PDF generated using pdfmake", style: "subheader" },
    //     "You can add paragraphs, tables, images, and much more!",
    //   ],
    //   styles: {
    //     header: {
    //       fontSize: 18,
